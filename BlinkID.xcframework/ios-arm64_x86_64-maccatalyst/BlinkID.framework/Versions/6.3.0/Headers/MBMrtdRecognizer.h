 ...
 */
MB_CLASS_AVAILABLE_IOS(13.0) MB_CLASS_DEPRECATED("MBMrtdRecognizer is deprecated. Use MBBlinkIdSingleSideRecognizer with mrz_id, mrz_visa, mrz_passport rights.") MB_FINAL
