//
//  PPCzIDCombinedRecognizerSettings.h
//  MicroBlinkDev
//
 ...
 *
 * Czech Combined ID recognizer is used for scanning both front and back side of german IDs.
 */
PP_CLASS_AVAILABLE_IOS(6.0)
@interface PPCzIDCombinedRecognizerSettings : PPCombinedRecognizerSettings
...
/**
 * Defines if glare detection should be turned on/off for both front and back side of Czech IDs.
 *
 * Default: YES
 */
