//
//  PPSwissPassportRecognizerSettings.h
//  MicroBlinkDev
//
...
/**
 * Settings class for configuring Swiss Passport Recognizer.
 *
 * Swiss Passport recognizer is used for scanning Swiss Passport.
 */
PP_CLASS_AVAILABLE_IOS(6.0)
@interface PPSwissPassportRecognizerSettings : PPRecognizerSettings
...
/**
 * Defines if owner's place of origin should be extracted from Swiss Passport
 *
 * Default: YES
 */
