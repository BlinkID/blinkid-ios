...
/**
 * Settings class for configuring German Old ID Recognizer.
 *
 * German Old ID recognizer is used for scanning front side of German Old ID
 */
PP_CLASS_AVAILABLE_IOS(6.0)
@interface PPGermanOldIDRecognizerSettings : PPRecognizerSettings
 ...
 * Default: NO
 */
@property (nonatomic, assign) BOOL extractFacePhoto;
 ...
 * Default: NO
 */
@property (nonatomic, assign) BOOL extractSignature;
...
/**
 * Defines if glare detection should be turned on/off for old German IDs.
 *
 * Default: YES
 */
