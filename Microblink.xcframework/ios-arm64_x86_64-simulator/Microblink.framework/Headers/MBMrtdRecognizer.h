 ...
 */
MB_CLASS_AVAILABLE_IOS(11.0) MB_CLASS_DEPRECATED("MBMrtdRecognizer is deprecated. Use MBBlinkIdRecognizer with mrz_id, mrz_visa, mrz_passport rights.") MB_FINAL
